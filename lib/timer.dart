    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 138.0, middle: 0.2355),
            Pin(size: 62.0, middle: 0.723),
            child:
                // Adobe XD layer: 'Card' (group)
                Stack(
              children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 53.0, middle: 0.705),
            Pin(size: 33.0, middle: 0.7144),
            child: Text(
              'Start',
              style: TextStyle(
                fontFamily: 'SF Compact',
          ...
          Pinned.fromPins(
            Pin(size: 76.0, middle: 0.284),
            Pin(size: 33.0, middle: 0.7155),
            child: Text(
              'Cancel',
              style: TextStyle(
                fontFamily: 'SF Compact',
