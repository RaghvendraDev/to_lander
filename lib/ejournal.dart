...
class ejournal extends StatelessWidget {
  ejournal();
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 92.0, start: 53.0),
            Pin(size: 30.0, start: 59.0),
            child: Text(
              'E-journal',
              style: TextStyle(
                fontFamily: 'SF Compact',
          ...
          Pinned.fromPins(
            Pin(size: 132.0, middle: 0.2801),
            Pin(size: 18.0, middle: 0.1936),
            child: Text(
              'November 18, 2021 ',
              style: TextStyle(
                fontFamily: 'SF Compact',
          ...
          Pinned.fromPins(
            Pin(size: 77.0, middle: 0.2344),
            Pin(size: 61.0, middle: 0.2287),
            child: Text(
              '09:00\nAM',
              style: TextStyle(
                fontFamily: 'SF Compact',
          ...
          Pinned.fromPins(
            Pin(size: 100.0, middle: 0.7803),
            Pin(size: 83.1, middle: 0.2091),
            child: Transform.rotate(
              angle: 0.0,
              child:
                  // Adobe XD layer: 'Button' (group)
                  ...
                  Pinned.fromPins(
                    ...
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromPins(
                          Pin(size: 11.7, middle: 0.6286),
                          Pin(size: 11.7, middle: 0.4602),
                          child:
                              // Adobe XD layer: 'Icon' (group)
                              Stack(
                            children: <Widget>[
